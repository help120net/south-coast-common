...
public class AppPageResultObj extends AppResultObj {
	...
	private Map<String, Object> dataExt;		//补充信息
	...
	public static AppPageResultObj notAllow() {
		return new AppPageResultObj(AppResultObj.CODE_NOT_ALLOW, "未经许可的用户", null, null, false);
	}
	...
	public static AppPageResultObj parameterError() {
		return new AppPageResultObj(AppResultObj.CODE_PARAM_ERR, "参数解析错误", null, null, false);
	}
	...
	public static AppPageResultObj serverError() {
		return new AppPageResultObj(AppResultObj.CODE_SERVER_ERR, "服务器异常", null, null, false);
	}
	...
	public static AppPageResultObj serverError(String msg) {
		return new AppPageResultObj(AppResultObj.CODE_SERVER_ERR, msg, null, null, false);
	}
}
